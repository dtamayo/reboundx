...
const char* rebx_version_str = "3.0.5";         // **VERSIONLINE** This line gets updated automatically. Do not edit manually.
...
void rebx_register_default_params(struct rebx_extras* rebx){
    ...
    rebx_register_param(rebx, "mass_splined", REBX_TYPE_INT);
