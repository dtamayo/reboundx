...
const char* rebx_version_str = "4.6.2";         // **VERSIONLINE** This line gets updated automatically. Do not edit manually.
...
void rebx_register_default_params(struct rebx_extras* rebx){
    ...
    rebx_register_param(rebx, "spherical_harmonics_model", REBX_TYPE_POINTER);
    rebx_register_param(rebx, "theta0", REBX_TYPE_DOUBLE);
