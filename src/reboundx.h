...
enum rebx_binary_field_type{
    ...
    REBX_BINARY_FIELD_TYPE_NAME=3,
    REBX_BINARY_FIELD_TYPE_PARAM_TYPE=4,
    REBX_BINARY_FIELD_TYPE_SHAPE=5,
    REBX_BINARY_FIELD_TYPE_CONTENTS=6,
    REBX_BINARY_FIELD_TYPE_END=7,
};
...
enum rebx_input_binary_messages {
    ...
    REBX_INPUT_BINARY_WARNING_VERSION = 2,
    REBX_INPUT_BINARY_WARNING_POINTERS = 4,
    REBX_INPUT_BINARY_WARNING_PARTICLES = 8,
    REBX_INPUT_BINARY_WARNING_INCOMPATIBLE_FORMAT = 16,
    REBX_INPUT_BINARY_WARNING_PARAM_NOT_LOADED = 32,
    REBX_INPUT_BINARY_WARNING_FIELD_UNKOWN = 128,
};
