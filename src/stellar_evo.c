/**
 * @file    stellar_evo.c
 * @brief   REWRITE***Add exponential mass loss/growth between timesteps in the simulation.***
 ...
 * ======================= ===============================================
 * 
 * REWRITE***This adds exponential mass growth/loss to individual particles every timestep.
 ...
 * **Particle Parameters**
 * 
 * REWRITE***Only particles with their ``tau_mass`` parameter set will have their masses affected.***
 * 
 * ============================ =========== =======================================================
...
// spline convenience function here
