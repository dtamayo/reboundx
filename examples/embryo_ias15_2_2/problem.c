...
int main(int argc, char* argv[]){
    char* filename = "embryo_ias15_2";
    struct reb_simulationarchive* sa = reb_simulationarchive_create_from_file(filename);
    struct reb_simulation* r = reb_simulation_create_from_simulationarchive(sa,7);
    ...
    reb_simulation_save_to_file_interval(r, "ias15_2.bin", 6./365.);
