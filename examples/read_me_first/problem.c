...
int main(int argc, char* argv[]){
	...
	rebx->gr.c = 3.e9;						/* Change the speed of light (somewhat dubious!) */
	printf("c = %e\n", rebx->gr.c);			/* prints 3.e9 */ 
	...
	/* Let's initialize an orbit an eccentric orbit at 1 AU with all angles set to 0 */
	double a = 1.496e11;	/* semimajor axis, in meters */
	double e = 0.01;		/* eccentricity */
	double pomega = 0.;		/* longitude of pericenter */
	double f = 0.;			/* true anomaly */
	double m = 6.e24; 		/* in kg */
	struct reb_particle p1 = reb_tools_orbit2d_to_particle(sim->G, sim->particles[0], m, a, e, pomega, f);
