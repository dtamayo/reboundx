...
char TITLE[100] = "embryo_ias15_bigstep_";
char TITLE_FAMTREE[100] = "famtree_bigstep_";
char TITLE_HEARTBEAT[100] = "heartbeat_bigstep_";
...
void heartbeat(struct reb_simulation* sim){
    if (reb_simulation_output_check(sim, 10)){
        FILE *fp = fopen(TITLE_HEARTBEAT, "a");  // append mode
        if (fp == NULL){
        ...
        fprintf(fp, "%e, ", sim->particles[3].vz);
        fprintf(fp, "%e, ", sim->particles[0].m);
        fprintf(fp, "%e, ", sim->particles[0].r);
        fprintf(fp, "%e, ", sim->particles[0].x);
        fprintf(fp, "%e, ", sim->particles[0].y);
        fprintf(fp, "%e, ", sim->particles[0].z);
        fprintf(fp, "%e, ", sim->particles[0].vx);
        fprintf(fp, "%e, ", sim->particles[0].vy);
        fprintf(fp, "%e \n ", sim->particles[0].vz);
