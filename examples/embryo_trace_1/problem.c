...
int main(int argc, char* argv[]){
    char* filename = "embryo_trace_1";
    struct reb_simulationarchive* sa = reb_simulationarchive_create_from_file(filename);
    struct reb_simulation* r = reb_simulation_create_from_simulationarchive(sa,145);
    ...
    reb_simulation_save_to_file_interval(r, "archive_timestep.bin", 6./356.);
