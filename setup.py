...
try:
    ...
    ghash_arg = "-DREBXGITHASH=42c065a06ba9c31b1023088df2f79bc97c37d371" #GITHASHAUTOUPDATE
...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/inner_disk_edge.c', 'src/modify_orbits_forces.c', 'src/gr_potential.c', 'src/integrator_implicit_midpoint.c', 'src/stochastic_forces.c', 'src/radiation_forces.c', 'src/central_force.c', 'src/linkedlist.c', 'src/modify_mass.c', 'src/gr.c', 'src/core.c', 'src/exponential_migration.c', 'src/integrator_rk4.c', 'src/integrator_rk2.c', 'src/rebxtools.c', 'src/gr_full.c', 'src/integrator_euler.c', 'src/output.c', 'src/tides_constant_time_lag.c', 'src/input.c', 'src/steppers.c', 'src/track_min_distance.c', 'src/type_I_migration.c', 'src/integrate_force.c', 'src/interpolation.c', 'src/gravitational_harmonics.c', 'src/modify_orbits_direct.c'],
