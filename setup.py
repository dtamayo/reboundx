...
try:
    ...
    ghash_arg = "-DREBXGITHASH=040a350ba7031d791b718ebda083e5fb9a591a14" #GITHASHAUTOUPDATE
...
setup(name='reboundx',
    ...
    setup_requires=['rebound>=3.6.0', 'numpy'],
    install_requires=['rebound>=3.6.0', 'numpy'],
