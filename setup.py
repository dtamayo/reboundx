...
try:
    ...
    ghash_arg = "-DREBXGITHASH=e4369de29737521a38ca6a10a556cb189fec8a3e" #GITHASHAUTOUPDATE
...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/exponential_migration.c', 'src/core.c', 'src/gr_potential.c', 'src/modify_orbits_direct.c', 'src/integrator_euler.c', 'src/central_force.c', 'src/gravitational_harmonics.c', 'src/output.c', 'src/linkedlist.c', 'src/rebxtools.c', 'src/gr.c', 'src/integrate_force.c', 'src/radiation_forces.c', 'src/interpolation.c', 'src/integrator_rk2.c', 'src/gr_full.c', 'src/modify_mass.c', 'src/steppers.c', 'src/modify_orbits_forces.c', 'src/integrator_implicit_midpoint.c', 'src/tides_constant_time_lag.c', 'src/integrator_rk4.c', 'src/track_min_distance.c', 'src/input.c', 'src/Inner_edge.c', 'src/type_I_migration.c'],
