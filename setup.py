...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/linkedlist.c', 'src/gr_full.c', 'src/integrator_implicit_midpoint.c', 'src/rebxtools.c', 'src/gravitational_harmonics.c', 'src/gas_damping_timescale.c', 'src/interpolation.c', 'src/stochastic_forces.c', 'src/yarkovsky_effect.c', 'src/integrator_euler.c', 'src/integrate_force.c', 'src/type_I_migration.c', 'src/integrator_rk4.c', 'src/modify_orbits_forces.c', 'src/track_min_distance.c', 'src/integrator_rk2.c', 'src/tides_spin.c', 'src/exponential_migration.c', 'src/output.c', 'src/inner_disk_edge.c', 'src/modify_mass.c', 'src/merging_collisions.c', 'src/steppers.c', 'src/gas_dynamical_friction.c', 'src/central_force.c', 'src/core.c', 'src/lense_thirring.c', 'src/tides_dynamical.c', 'src/gr.c', 'src/input.c', 'src/modify_orbits_direct.c', 'src/tides_constant_time_lag.c', 'src/fragmenting_collisions.c', 'src/gr_potential.c', 'src/radiation_forces.c'],
