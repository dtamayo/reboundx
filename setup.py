...
try:
    ...
    ghash_arg = "-DREBXGITHASH=8a50341bc036b2840b5be9e55f3cd7b1969b4f90" #GITHASHAUTOUPDATE
...
setup(name='reboundx',
    ...
    setup_requires=['rebound==3.16.0', 'numpy'], # > 3.10.0
    install_requires=['rebound==3.16.0', 'numpy'], # > 3.10.0
