...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/track_min_distance.c', 'src/gas_damping_timescale.c', 'src/interpolation.c', 'src/modify_orbits_forces.c', 'src/j2.c', 'src/steppers.c', 'src/integrator_implicit_midpoint.c', 'src/rebxtools.c', 'src/modify_mass.c', 'src/tides_constant_time_lag.c', 'src/gr_potential.c', 'src/central_force.c', 'src/output.c', 'src/gravitational_harmonics.c', 'src/gas_dynamical_friction.c', 'src/core.c', 'src/gr_full.c', 'src/integrator_euler.c', 'src/tides_spin.c', 'src/type_I_migration.c', 'src/integrator_rk2.c', 'src/radiation_forces.c', 'src/input.c', 'src/exponential_migration.c', 'src/yarkovsky_effect.c', 'src/inner_disk_edge.c', 'src/linkedlist.c', 'src/gr.c', 'src/integrate_force.c', 'src/stochastic_forces.c', 'src/lense_thirring.c', 'src/modify_orbits_direct.c', 'src/integrator_rk4.c'],
