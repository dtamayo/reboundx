...
libreboundxmodule = Extension('libreboundx',
                    sources = [ 'src/central_force.c', 'src/core.c', 'src/gr.c', 'src/gr_full.c', 'src/gr_potential.c', 'src/modify_mass.c', 'src/modify_orbits_direct.c', 'src/modify_orbits_forces.c', 'src/radiation_forces.c', 'src/rebxtools.c', 'src/tides_precession.c'],
                    include_dirs = ['src'],
                    library_dirs = [],
