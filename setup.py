...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/tides_constant_time_lag.c', 'src/integrator_rk4.c', 'src/integrator_euler.c', 'src/gr_potential.c', 'src/integrator_implicit_midpoint.c', 'src/interpolation.c', 'src/input.c', 'src/gr_full.c', 'src/integrate_force.c', 'src/radiation_forces.c', 'src/gr.c', 'src/output.c', 'src/stochastic_forces.c', 'src/modify_orbits_forces.c', 'src/central_force.c', 'src/inner_disk_edge.c', 'src/core.c', 'src/rebxtools.c', 'src/yarkovsky_effect.c', 'src/gravitational_harmonics.c', 'src/steppers.c', 'src/exponential_migration.c', 'src/modify_orbits_forces_ema.c', 'src/modify_mass.c', 'src/type_I_migration.c', 'src/modify_orbits_direct.c', 'src/integrator_rk2.c', 'src/track_min_distance.c', 'src/linkedlist.c'],
