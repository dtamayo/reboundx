...
project = 'REBOUNDx'
copyright = '2015, Dan Tamayo, Hanno Rein, Pengshuai (Sam) Shi'
author = 'Dan Tamayo, Hanno Rein, Pengshuai (Sam) Shi'
...
latex_documents = [
  (master_doc, 'REBOUNDx.tex', 'REBOUNDx Documentation',
   'Dan Tamayo, Hanno Rein, Pengshuai (Sam) Shi', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'REBOUNDx', 'REBOUNDx Documentation',
   author, 'REBOUNDx', 'One line description of project.',
   'Miscellaneous'),
]
